...
server. The Sonatype CLM server can be integrated to validate policies
as part of your usage of the staging suite of Nexus. 

Detailed instructions on how to configure the CLM server as well as
the integration in Nexus can be found in the Sonatype CLM 
