...
This project includes examples forintegration with the Nexus staging Ant tasks.
...
An example project showcasing this integration is available in the https://github.com/sonatype/nexus-book-examples[Nexus book examples project]. 
