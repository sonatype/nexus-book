...
the deployment as well as the user agent string sent by the deployment.
...
POM must not contain release repository:: This rule can ensures that
no release repository is defined for the distribution management of
the project
