...
. A developer deploys a component (or a set of components) to Nexus
Professional.
...
not allow updating 
component='/com/sonatype/training/nexus/explicit-staging-example/t1.0.0/staging-example-1.0.0.jar'
[ERROR]     * Artifact updating: Repository ='releases:Releases' does 
not allow updating 
component='/com/sonatype/training/nexus/explicit-staging-example/1.0.0/staging-example-1.0.0.pom'
[ERROR] 
[ERROR] 
----
...
image::figs/web/staging_component-upload.png[scale=60]
