...
{pro} and {oss} support the Python Package Index (PyPI) for proxy, hosted, and group 
repository formats, which you can share within your organization. This allows the repository manager to take 
advantage of the packages in the official Python Package Index and other public registries without incurring 
