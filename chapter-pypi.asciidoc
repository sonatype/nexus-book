...
TIP: If using pip with the repository manager, strongly consider setting up your repository manager to use SSL as
documented in <<ssl>>.  Otherwise, you will likely need to put --trusted-host additions at the end of many 
