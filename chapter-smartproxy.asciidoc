...
image::figs/web/smart-proxy-repo-list-hosted.png[scale=70]
...
image::figs/web/smart-proxy-repo-list-proxy.png[scale=70]
...
image::figs/web/smart-proxy-subscribe-connected.png[scale=70]
