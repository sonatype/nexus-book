...
Sonatype Nexus OSS as well Sonatype Nexus Pro are
...
Nexus Pro Users::: General discussion and support for
...
Sonatype, projects run by Nexus Pro customers or Nexus OSS users 
...
jenksing plugin to add custom metadata with deployments to Nexus Pro.
