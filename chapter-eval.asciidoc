...
gradle command with +gradlew+ instead of +gradle+.
...
for Apache Maven, Gradle and Apache Ant/Apache Ivy based builds. Other
build tools like SBT or Leiningen can be configured to do the same and
...
* Configure to download components from Nexus
