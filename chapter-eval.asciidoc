...
complex work flows that can keep track of the state of a
component. Organizations can use the Custom Repository Metadata
service alongside the rich REST API offered in Nexus to create custom
...
.Conclusion
**** 
If your organization has custom requirements for tracking component
 metadata, the Custom Repository Metadata can be used to extend the
 set of attributes stored with a particular component.
****
