...
* *Step 2:* Run the Nexus Pro Installer.

* *Step 3:* Start Nexus from the Nexus Pro Installer.
...
to demonstrate the features of Nexus OSS and Nexus
...
Nexus Pro and Open Source can be used as a publishing
...
Nexus Pro can improve collaboration and control, while
...
Once NuGet packages are published to your Nexus Pro instance
...
. Publish a NuGet Package to Nexus Pro -> http://books.sonatype.com/nexus-book/reference/nuget-deploying_packages_to_nuget_hosted_repositories.html[Read more...]
...
When you need LDAP integration, you will benefit from using Nexus
 Professional. Nexus Pro can support the largest development
