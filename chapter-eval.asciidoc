...
+
----
[ivy:retrieve] 	found org.jbundle.util#org.jbundle.util.jbackup;2.0.0 in nexus
[ivy:retrieve] 	found org.jbundle.util#org.jbundle.util.apprunner;2.0.0 in nexus
[ivy:retrieve] 	found commons-net#commons-net;2.2 in nexus
[ivy:retrieve] 	found commons-httpclient#commons-httpclient;3.1 in nexus
[ivy:retrieve] 	found commons-logging#commons-logging;1.1.1 in nexus...
----
...
----
<dependencies>
      <dependency org="org.sonatype.nexus.trial" name="simple-project" rev="1.0.0-SNAPSHOT"/>
    </dependencies>
----
+
During the build, it is relying on Nexus when it attempts to retrieve
