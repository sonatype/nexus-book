...
working connection, press 'Save' to confirm the configuration.
...
to the Crowd managed user* in order to 'Save'. The external Crowd User Example displays the +johnsmith+
