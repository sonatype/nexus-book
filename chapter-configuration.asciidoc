...
The most common reason why the address would be different for end users, is if you have a <<reverse-proxy,reverse 
proxy>> in front of the {pro} terminating HTTP requests at a different address than where the repository manager 
is running.
