...
repositories. Any component that has not been requested in the configured amount of days will be purged.

Purge Unused Maven Snapshots:: This task can be used to remove unused snapshots from Maven repositories. Any snapshot
that has not been requested in the configured amount of days will be purged.
