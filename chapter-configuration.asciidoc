...
Health Check:: the result counts for a repository health check.
...
[[fig-repo-config-2]]
.Additional Configuration for a Proxy Repository
...
image::figs/web/repository-manager_repository-config-3.png[scale=100]

The bottom of <<fig-repo-config>> and <<fig-repo-config-2>> combined show the repository configuration screen for 
