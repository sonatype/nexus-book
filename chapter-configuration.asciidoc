...
on a webserver of your choice or upload a bundle to a Nexus repository
and configure the 'Override URL' to point to the bundle. The bundle is
is just a zip file with static HTML file named +index.html+ and
related content.
