...
////
The As documented in <<selector-reference>>
////
...
////
Joes summary: 1) create the content selector telling you what data/components you want your user to have 
permission to see 2) create a privilege to define of the permissible data what your want the user to be able to 
do to it 3) then you assign a role 4) give it to the user
////
...
Below are the allowable attributes for content selectors
