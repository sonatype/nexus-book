...
displayed, if the remote storage uses HTTPS. The 'View certificate'
button triggers the display of the SSL certificated details in a
dialog. The dialog allows you to add or remove the certificate from
the certificate truststore maintaine dby Nexus.
