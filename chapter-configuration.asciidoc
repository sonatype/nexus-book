...
http://repo1.maven.org/maven2/ is used, while Nexus Pro has
...
download of all versions of a component in contrast to the default
...
Open Source and Nexus Pro. It allocates space underneath the
