...
Furhter information about the CRON expression can be found in the http://www.quartz-scheduler.org/documentation/quartz-2.2.x/tutorials/crontrigger.html[documentation of the Quartz Scheduler library].
