...
TIP: The default user for accessing these features has the username 'admin' and the password 'admin123'. 

Some features are only available in {pro}. The 'Administration' menu contains the following sections:
