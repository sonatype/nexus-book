...
A paid license is necessary to upgrade {oss} to {pro}, and to keep {pro} features operational once upgraded. Licenses
are special ".lic" files that can be uploaded using the 'Licensing' section of the 'Administration' menu in the main
menu section.
...
From the 'Licensing' section of the 'Adminstration' menu, you should see a summary of the existing license information
and a *button name* button near the bottom of the page:

(license page shot)

To upload a license,
* press the 'button name' button
* select the correct +.lic+ file in the file selection dialog, and press 'Open button name'
* press the 'Install License' button

At this point you will see a login confirmation dialog,

(login confirmation shot)

Enter your password and press 'continue button name'

Now the terms of service dialog appears,

(license shot)

When you have reviewed the terms of service, press 'agree to terms button'

If the license upload is successful, you will briefly see a success message in the upper-right portion of the screen,

(success message shot)
