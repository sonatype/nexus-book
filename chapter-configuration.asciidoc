...
* Accessing nodes for active-active high availability
...
You will be able to see a table or one more nodes identified by 'UUID', 'Local', and 'Socket Address'. All
additional servers synchronized with high availability are displayed on the 'Nodes' screen. View the table
