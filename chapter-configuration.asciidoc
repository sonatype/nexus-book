...
The branding plugin is part of {pro} and allows you to customize
your Nexus instance by replacing the default {pro} logo in the top
left-hand corner of the header with an image of your choice.
...
{oss} and {pro}. It allocates space underneath the
