...
running this job is not enough to reclaim disk space. Running a 'Compact blob store' task will restore the space. 
When you create a scheduled task to remove snapshots, you can specify the 'Repository/Group' to 
affect as well as:
