...
task generates a list of all versions of a compoent for each groupId
...
semantics for support of specific classifiers. Further details can be
...
+
The Repository Target parameter can be used to narrow down the content
