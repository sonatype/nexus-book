...
by editing the logback-nexus.xml file and other logback* files found in
sonatype-work/nexus/conf. When upgrading we suggest to remove the
files and manually recreate any customizations done prior to the
