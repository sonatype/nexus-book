...
Nuget.org. With Nexus 2.11.3 is has been changed to perform no operation
at all to avoid this problem. It is save to remove any executions of
this task.
...
Synchronize Proxied RubyGems Metadata Files:: This task can be used to 
