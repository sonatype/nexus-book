...
Maximum component age:: Tells Nexus what the maximum age of a
component is, before it retrieves a new version from the remote
repository.

Maximum metadata age:: Tells Nexus how long to cache metadata before
rechecking the remote repository.  If the metadata is component metadata,
it uses the longer of this value and 'Maximum component age' before
rechecking.
