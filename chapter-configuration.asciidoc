...
Content selectors provide a means for you to select specific content from all of your content. You can 
create a content selector filter to match characters on the path of components in a repository. The content you 
select is evaluated against a JEXL expression. https://commons.apache.org/proper/commons-jexl/[JEXL] is a 
expression library you will use to script queries along specific paths and coordinates available to your 
repository manager formats.
