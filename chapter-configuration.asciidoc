...
example, when using the User Token feature or NuGet repositories. A key becomes unused, when the user account is
deleted is deleted. The task purges these orphaned API keys and should be scheduled to run regularly to remove
these redundant keys.
