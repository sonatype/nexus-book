...
image:figs/web/ui-admin-button.png[scale=50] in the main toolbar.
...
keep it like that with e.g., 'HTTP' or 'Email Server' settings, but
also 'Templates' for users and 'Tasks' to run regularly.
