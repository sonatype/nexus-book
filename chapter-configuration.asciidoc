...
.License info screen
image::figs/web/admin-license-info.png[scale=50]
...
* in the re-authentication dialog enter your password and press 'Authenticate'

.Re-authenticate to manage licenses
image::figs/web/admin-license-authenticate.png[scale=40]
* when you have reviewed the terms of service, press 'I agree'

.License Terms of Service agreement
image::figs/web/admin-license-tos.png[scale=40]

If the license upload is successful, you will briefly see a success message in the upper-right portion of the screen:

.Successful license upload
image::figs/web/admin-license-success.png[scale=50]
...
License Certificate has expired:: The license you uploaded is already expired.
Unable to verify license:: The license file is not a valid license format.
Invalid licensing subject:: The current product is not included in the license file.
