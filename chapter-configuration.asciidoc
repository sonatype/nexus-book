...
'Remove if released';; The checked 'Remove if released' will delete/remove all corresponding snapshot releases.
...
in the 'Minimum snapshot count' dropdown. Also, it is possible to configure the task in such a 
