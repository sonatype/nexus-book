...
Purge Unused Components and Assets:: This task can be used to remove components and assets in repositories. Any
component that has not been requested in the configured number of days will be purged.
