...
Compact blob store:: Deletions of binary assets in a blob store are only removing the reference. This does not
result in freed up storage space. This performs the actual deletion of all blobs.
