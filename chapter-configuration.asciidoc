...
The paid license is a special +.lic+ file that can be uploaded from the 'Licensing' section located in the 
'Administration' menu. To install it, locate the file with the 'Select license...' button in the user interface. 
...
After the file is selected and uploaded, the 'License type' field will display the corresponding bundle 
purchased. Options include {iq} with {pro}, or {pro} alone.
