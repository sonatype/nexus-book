...
you from all our your content. The regular expressions are implemented with JEXL, a scripting language, that 
allows filtering and querying on component patterns.

////
expand this section
 - processes select parts of a repository
 - applies security to parts of a repository
 - defines the contents of a virtual repository
 - applicable to repo targets from version 2 during upgrade
////
...
////
See demo video https://drive.google.com/a/sonatype.com/file/d/0B3bXeD4zjEu7bnAwc1ctaWgzUHc/view?pli=1
////


===== Creating and Managing Content Selector Privileges

Once you have created a content selector, you can utilize it as part of your security setup. You can add a new 
privilege that relates to the target and controls the CRUD (Create, Read, Update and Delete) operations for 
artifacts matching that path. The privilege can even span multiple repositories.
...
With this setup you can delegate all control of components in +org.apache.maven+ to a "Maven" team. In this way, 
you don’t need to create separate repositories for each logical division of your components.
...
===== Upgrading Repository Targets to Content Selectors
