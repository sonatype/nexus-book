...
for the 'maven2 (proxy)' recipe. Additionally, you must register for an account to access the external repository.
Configure the proxy repository to access `https://maven.oracle.com`, with these steps:
