...
Proxying the Oracle Maven Repository (`https://maven.oracle.com`) requires special HTTP options in a 'maven2
(proxy)'. Additionally, you must register for an account to access the external repository. Configure the
proxy repository to access `https://maven.oracle.com`, with these steps:

1. Check 'Authentication'.
2. Select 'Username' as the 'Authentication type'.
3. Enter the 'Username' and 'Password' of the Oracle Maven Repository.
