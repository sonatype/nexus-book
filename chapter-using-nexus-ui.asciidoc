...
component information and a list of associated assets. An example is displayed in <<fig-component-information>>.
...
To delete a component select one on the list, then press the 'Delete component' button above. A modal will pop up 
to confirm the deletion.

[[delete-component-example.png]]
.Delete Component from a Proxy or Hosted Repository
image::figs/web/delete-component-example.png[scale=35]

When you delete the component it will remove all associated assets. You can only delete 
hosted and proxy repositories.

NOTE: Certain components will remain after deletion. While a Docker image can be deleted its layers component 
cannot.
