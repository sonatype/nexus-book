...
To analyze an application press the 'Analyze application' button as shown in <<fig-component-details>>. A modal will pop
up to request further information from you such as email address, report password, a list of proprietary packages
for the application, and a name for the report. Once you have provided this information, press the Analyze button as 
shown in <<fig-analyze-application>>. Your report link will be emailed to you as soon as it is finished.
