...
image::figs/web/component-info-tab-jetty.png[scale=30]
...
image::figs/web/component-info-cve-jetty.png[scale=20]
  
[[fig-clm-osvdb-jetty]]
.Open Source Vulnerability DataBase OSVDB Entry for a Jetty Security Issue
image::figs/web/component-info-osvdb-jetty.png[scale=20]
