...
<<fig-using-component-information>>. Besides showing details like the
...
[[fig-using-component-information]]
.Viewing the Artifact Information
image::figs/web/using-component-information.png[scale=50]
...
coordinatess of a component. These are 'Group' (groupId), 'Artifact'
...
.Artifact Upload Tab
image::figs/web/using_component-upload.png[scale=50]
