...
To analyze a component press the 'Analyze application' button as shown in <<fig-component-details>>. A modal will pop
up to request further information from you such as email address, report password, a list of properitary packages
for the component, and a name for the report. Once you have provided this information, press the Analyze button as 
