...
part of {pro}. You can view, edit, and search for
...
the Sonatype hosted data services usage in {pro} and {pro}+ may 
still be a little unclear. Rather you are likely asking, "What do I get with {pro}+?

Great question. {pro}+ you get a Nexus Lifecycle server. This expands {pro} 
in two key areas.
