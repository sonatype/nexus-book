...
Locally cached:: set to 'true' if the asset can be found in the repository manager storage, 'false' indicates 
that the metadata about the asset is available, while the asset itself has not been downloaded
