...
image::figs/web/repository-manager-example-interface.png[scale=80]
...
You can copy the text from the panel or use the 'Print' button to
produce a document that can be sent via email or attached to a support
request.
