...
To delete a component select one on the list, then press the 'Delete component' button above. When you delete the 
component it will remove all associated assets. You can only delete hosted and proxy repositories.
