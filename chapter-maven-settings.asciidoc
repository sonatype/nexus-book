...
can configure the proxy related parameters +proxy+,
...
If your Nexus is hosted internally and does not use https you can
...
connect the computer to Nexus for following Maven invocations a simple HTTP
GET command to retrieve an unmodified settings file can be used:
