...
library added when from official library - is displayed in UI .. maybe file bug
...
Examples for pulling various imagesfrom a Nexus server running on the host `nexus.example.com` and exposing a Docker
repository group with a Docker connector port of 18443 looks are:

----
docker pull nexus.example.com:18443/mysql
docker pull nexus.example.com:18443/bitnami/node
docker pull nexus.example.com:18443/bitnam
----
