...
You can also allow a user with privileges to a group repository, which provides the user to access any content within any member repository in that group. 
