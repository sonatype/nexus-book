...
* user account and access right management related to Nexus user
  interface as well as to component access
* configuration of security backends including the built-in system as
  well as LDAP
////
...
available in the 'Security' section of the 'Administration' main
...
external storage in an LDAP system.
////
...
The 'NuGet API-Key Realm' is needed
