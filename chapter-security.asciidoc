...
As seen in <<fig-realm>>, activate your 'LDAP Realm' by following these steps:
...
This Object Class (inetOrgPerson) contains standard fields such as 'mail' or 'uid'. Other possible values are 
...
image::figs/web/dynamic-group-type.png[scale=50]
