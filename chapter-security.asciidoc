...
The button 'Load certifacte' above the list of certificated can be used to add a new certificate to the truststore by
...
Next, define the port you want to use for the HTTPS connection by setting the +application-port-ssl+ property in
