...
The +settings.xml+ lives in `$HOME/.m2`, your main Maven directory. This file contains listings for 
...
Upon activation of user tokens for repository authentication you must access the repository manager with the user 
