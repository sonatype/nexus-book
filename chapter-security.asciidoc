...
2. Choose a role from the selection panel.
3. Assign the 'nx-usertoken-current' privilege to the role, then save the change.

When enabled, you can access your individual token on your account menu. To access the menu select the username,
on the top right-hand corner of the user interface. In the 'User' menu, to the left, you will see the 
