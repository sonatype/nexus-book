...
image::figs/web/privileges-list.png[scale=50]
...
image::figs/web/privileges-types.png[scale=50]
...
Each type has a unique form that varies in scope of the privilege. 
...
[[fig-privileges-repository-admin]]
.Creating a Repository Admin Privilege
image::figs/web/privileges-repository-admin.png[scale=50]

[[fig-privileges-repository-view]]
.Creating a Repository View Privilege
image::figs/web/privileges-repository-view.png[scale=50]

[[fig-privileges-script]]
.Creating a Script Privilege
image::figs/web/privileges-script.png[scale=50]

[[fig-privileges-wildcard]]
.Creating a Wildcard Privilege
image::figs/web/privileges-wildcard.png[scale=50]

Click the 'Create privilege' button to establish a new custom privilege. The new, saved privilege can be found
listed among the default privileges on the main 'Privileges' screen.
