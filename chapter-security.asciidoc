...
username and password authentication. When enabled, the realm is automatically added to the 'Active Realms'
list. A full description of this realm is documented in <<user-token-realms>>.
