...
+nexus-2.9.1-02-bundle.zip+ or +nexus-2.9.1-02-bundle.tar.gz+.
...
----
$ unzip nexus-2.9.1-02-bundle.zip
----
...
----
$ unzip nexus-professional-2.9.1-02-bundle.zip
...
assumes that Nexus is installed in +/usr/local/nexus-2.9.1-02+
...
The Nexus installation directory +nexus-2.9.1-02+ or
+nexus-professional-2.9.1-02+ has a sibling directory named
...
+nexus-2.9.1-02.war+ file in +$TOMCAT_HOME/webapps+ and restart your
Tomcat instance. Assuming that Tomcat is configured on port 8080 once
Tomcat is started, Nexus will be available on
http://localhost:8080/nexus-2.9.1-02[http://localhost:8080/nexus-2.9.1-02].

If you would like a less verbose URL, copy +nexus-2.9.1-02.war+ to a
