...
----
tail -f /opt/sonatype-work/nexus3/data/log/nexus.log
----
...
by the repository manager. The default location of the data directory is nested inside `sonatype-work`. In this
...
to use the absolute path `/opt/sonatype-work/nexus3/data` change the values as follows:

----
-Dkaraf.data=/opt/sonatype-work/nexus3/data
-Djava.io.tmpdir=/opt/sonatype-work/nexus3/data/tmp
----
