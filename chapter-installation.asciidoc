...
////
TBD .. verify above works with ubuntu and RHEL .. or find similar commands like /etc/init.d/nexus start
TBD how to configure startup at boot, e.g. update-rc.d or whatever .. depends on Ubuntu vs Redhat
////
