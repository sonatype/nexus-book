...
----
tail -f /opt/nexus/../sonatype-work/nexus3/data/log/nexus.log
----
...
by the repository manager. This is a sibling to the installation directory and contains your own configurations
and data. The default location of the data directory is nested inside `sonatype-work`. In this documentation it is
...
The data directory, found at `sonatype-work/nexus3/data`, contains subdirectories such as `blobs`, `db`,
...
to use the absolute path `/opt/nexus/..sonatype-work/nexus3/data` change the values as follows:

----
-Dkaraf.data=/opt/nexus/..sonatype-work/nexus3/data
-Djava.io.tmpdir=/opt/nexus/..sonatype-work/nexus3/data/tmp
----
