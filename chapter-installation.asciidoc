...
upgrade an existing installation. To keep the upgrade simple be sure to schedule some downtime to properly 
execute the upgrade.
...
To upgrade the repository manager, you can either unpack the archive in the directory that contains the existing 
installation. To learn more the proper steps review the 
https://support.sonatype.com/hc/en-us/articles/217967608[knowledge base].
