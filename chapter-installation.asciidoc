...
With the Nexus 2.5 release Java 6 support has become deprecated
following the discontinued support for Java 6 itself. Java 6 is no
longer support for Nexus 2.6 and higher.
