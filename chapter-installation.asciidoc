...
https://www.sonatype.com/download-oss-sonatype[Sonatype's download page] and choose the .tar.gz file or .zip file 
that suits your need from the 'Nexus Repository Manager OSS 2.x' section. The downloaded file will match the 
exact link +nexus-{version-exact}-bundle.tar.gz+ or +nexus-{version-exact}-bundle.zip+ respectively.
