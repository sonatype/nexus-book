...
+nexus-2.11.2-04-bundle.zip+ or +nexus-2.11.2-04-bundle.tar.gz+.
...
----
$ unzip nexus-2.11.2-04-bundle.zip
----

And, if you download the GZip'd TAR archive, run:

----
$ tar xvzf nexus-2.11.2-04-bundle.tar.gz
----

For Nexus professional the equivalent commands would be 

----
$ unzip nexus-professional-2.11.2-04-bundle.zip
$ tar xvzf nexus-professional-2.11.2-04-bundle.tar.gz
----
...
assumes that Nexus is installed in +/usr/local/nexus-2.11.2-04+
...
----
$ sudo cp nexus-2.11.2-04-bundle.tar.gz /usr/local
$ cd /usr/local
$ sudo tar xvzf nexus-2.11.2-04-bundle.tar.gz
$ sudo ln -s nexus-2.11.2-04 nexus
----
...
The Nexus installation directory +nexus-2.11.2-04+ or
+nexus-professional-2.11.2-04+ has a sibling directory named
