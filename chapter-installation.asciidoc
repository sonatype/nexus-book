...
+nexus-2.7.0-04-bundle.zip+ or +nexus-2.7.0-04-bundle.tar.gz+.
...
----
$ unzip nexus-2.7.0-04-bundle.zip
----

And, if you download the GZip'd TAR archive, run:

----
$ tar xvzf nexus-2.7.0-04-bundle.tar.gz
----

For Nexus professional the equivalent commands would be 

----
$ unzip nexus-professional-2.7.0-04-bundle.zip
$ tar xvzf nexus-professional-2.7.0-04-bundle.tar.gz
----
...
assumes that Nexus is installed in +/usr/local/nexus-2.7.0-04+
...
----
$ sudo cp nexus-2.7.0-04-bundle.tar.gz /usr/local
$ cd /usr/local
$ sudo tar xvzf nexus-2.7.0-04-bundle.tar.gz
$ ln -s nexus-2.7.0-04 nexus
----
...
The Nexus installation directory +nexus-2.7.0-04+ or
+nexus-professional-2.7.0-04+ has a sibling directory named
...
+nexus-2.7.0-04.war+ file in +$TOMCAT_HOME/webapps+ and restart your
Tomcat instance. Assuming that Tomcat is configured on port 8080 once
Tomcat is started, Nexus will be available on
+http://localhost:8080/nexus-2.7.0-04+

If you would like a less verbose URL, copy +nexus-2.7.0-04.war+ to a
