...
+nexus-2.11.3-01-bundle.zip+ or +nexus-2.11.3-01-bundle.tar.gz+.
...
----
$ unzip nexus-professional-2.11.3-01-bundle.zip
$ tar xvzf nexus-professional-2.11.3-01-bundle.tar.gz
----
...
assumes that Nexus is installed in +/usr/local/nexus-2.11.3-01+
...
----
$ sudo cp nexus-2.11.3-01-bundle.tar.gz /usr/local
$ cd /usr/local
$ sudo tar xvzf nexus-2.11.3-01-bundle.tar.gz
$ sudo ln -s nexus-2.11.3-01 nexus
----
...
The Nexus installation directory +nexus-2.11.3-01+ or
+nexus-professional-2.11.3-01+ has a sibling directory named
