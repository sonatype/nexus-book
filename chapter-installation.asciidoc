...
`backup/` :: If you have configured a scheduled task to export Orient databases, this directory will contain a
number of +.bak+ files that contain snapshots of the Orient databases.
