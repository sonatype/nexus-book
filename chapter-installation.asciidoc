...
The extraction process creates two sibling directories, the 'installation directory' and the 'data directory'. Further details about these folders can be found in <<directories>>.
