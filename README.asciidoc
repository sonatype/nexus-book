...
An introduction to repository management and the official documentation for http://www.sonatype.org/nexus/[{base} {oss}] 
and http://www.sonatype.com/Products/Nexus-Professional[{base}].
