...
Using authentication to publish further requires the +npm Bearer Token Realm+ to be activated within your Nexus 
instance. To do this, simply add the realm to the active realms in the +Realms+ feature of the +Security+ menu 
from the +Administration+ menu in Nexus.
