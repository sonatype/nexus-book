...
allows you to toggle between two listsdisplaying further details. Select to 'View By: Vulnerabilities' to inspect 
the security issues and 'View By: Artifacts' to review the license information. Both lists have a filter for each column 
...
by the {ds}. The next columns for the GAV parameters allow you to
