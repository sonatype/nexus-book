...
to simply click the 'Analyze' button'. After pressing this button, you will be
prompted to either analyze all or only the selected repository.
...
Repositories tab ope, be be sure to refresh Nexus to avoid viewing older data.
