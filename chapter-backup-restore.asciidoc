...
To configure and run a new task for database backup, review the steps in the Configuration chapter. As seen
in <<fig-backup-task>> you will also be required to complete the 'Backup location' where you choose a directory
in your filesystem to store backup data.
...
[[fig-backup-task]]
.Example Manual Database Backup Task 
image::figs/web/backup-task.png[scale=60]
