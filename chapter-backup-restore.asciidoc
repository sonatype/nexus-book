...
procedure you can configure your repository manager to save the Orient databases that store your component
metadata and system configurations.

You can configure this task to export settings and metadata from your repository manager's underlying databases.
When running the task it:
...
3. Copy the `.bak` files you wish to restore.
