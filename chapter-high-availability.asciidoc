...
* Configure three servers to establish the connection between the nodes by enabling the service in each repository
manager.
* Join the nodes together by a common blob store path to maintain a shared storage for repository manager data.
