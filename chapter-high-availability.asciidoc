...
deployment. This chapter explains why you would use HA-C, how it works, supported architectures for deploying 
...
HA-C is not intended to improve the throughput or performance of a {rm} deployment, nor is it a replacement for
