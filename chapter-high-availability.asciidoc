...
The default will not be shared with the additional nodes; therefore you need to configure your repositories
to point to new shared blob store location.

To configure the location where blob store data can be shared:
