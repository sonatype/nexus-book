...
.Testing multicast from the server side:
[source,sh]
>>>>>>> 17fe0fa9222a276a1ebeab52097707c5fa47d8d7
----
...
see the documentation for http://docs.hazelcast.org/docs/3.6/manual/html-single/index.html#setting-up-clusters[Hazelcast cluster configuration].
