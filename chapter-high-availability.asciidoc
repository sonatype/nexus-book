...
* Convert an older version of {pro} 3 into a high availability cluster.
...
1. Upgrade your existing repository manager to version 3.3.
2. Set the location for the second repository manager in your file system so the nodes share same the blob store.
