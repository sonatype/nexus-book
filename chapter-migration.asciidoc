...
There are two architectures you can build to support a migration. You can either move components from versions 2 
to 3 on an external server (e.g. reverse proxy) or the same server and run it in parallel.
