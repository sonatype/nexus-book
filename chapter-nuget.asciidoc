...
exposed in the user interface to normal users. Only users with at least
the 'Deployment' role have access to the API keys.
...
NuGet repositories exposed in a group, you provide the 'Name' and 'Source'
to the Visual Studio configuration for the 'Package Sources' of the
'NuGet Package Manager' as displayed in
...
NuGet repository will be available in the 'NuGet Package Manager' in Visual
Studio.
