...
IMPORTANT: Usage of the API key requires the 'NuGet API-Key Realm' to be activated. To do this, simply add the realm to the active
...
to the hosted repository created in <<nuget-nuget_hosted_repositories>> using the URL
