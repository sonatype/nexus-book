...
longer necessay and most users should remove the task and carefully
...
proxies the NuGet Gallery, an NuGet hosted repository with internal
...
'Administration' sub menu of the left hand navigation 'Nexus' panel.
...
repository you want to deploy to. Using the +delete+ command of nuget
