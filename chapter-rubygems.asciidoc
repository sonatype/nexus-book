...
If you are using {pro} and are proxying a repository via
...
After successful installation you can push your gem to a desired
repository. The initial invocation will request the URL for the GEM
repository and the Nexus credentials needed for deployment. Subsequent
pushes will used the cached information.
