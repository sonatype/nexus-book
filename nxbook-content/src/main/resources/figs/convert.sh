...
CONVERT_OPTS=" -verbose -bordercolor white -border 10x10 \( +clone -background black -shadow 80x3+5+5 \) -compose DstOver -composite -compose Over ";
...
CONVERT_OPTS=" -resize 250% -density 150 -verbose -bordercolor white -border 10x10 \( +clone -background black -shadow 80x3+5+5 \) -compose DstOver -composite -compose Over ";
