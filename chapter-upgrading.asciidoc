...
NOTE:: If your HTTP or HTTPS proxy settings for your source {nxrm} 2 are invalid during an upgrade, the target
{nxrm} 3 will ignore them. Instead, version 3 will use its original settings. A warning will be generated in the
log if this error occurs.
