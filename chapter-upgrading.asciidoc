...
The time to complete these steps depends on the amount of components transferred and can range from
minutes to hours and potentially beyond. With that in mind, your upgrade plan will allow you to upgrade content and configurations incrementally, from version 2 to version 3.
