...
table. Alternatively, you can select each individual repository. In addition to 'Repository', the table displays
information about the status of the repository. Keep in mind that the 'Repository ID' defined in version 2 is
displayed in the list and after the upgrade used as the 'Name' of the repository.
