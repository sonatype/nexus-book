...
2 instance prior to the upgrade as well as reconfiguring {nxrm} 3 after the upgrade.
...
enough file handlers avaialble for the content you want to transfer during the upgrade process.
