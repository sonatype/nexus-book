...
{nxrm} version 2.14 to 3.1.

The core feature of this tool allows {nxrm} version 3 to talk to version 2. This is done through a capability
that communicates directly with the upgrade tool, and walks you through a customized upgrade method (i.e. plan).
The plan you create with version 3 will provide a wizard-like approach that guides you through an upgrade from
{nxrm} 2.14 or higher to {nxrm} 3.1 or higher.

While the tool will provide an easier path, there may be specific items unique to your installation and upgrade
needs. As with any major system upgrade or your organization should put strong emphasis on performance and
stability. If in doubt, Sonatype provide a number of support options including a detailed
https://support.sonatype.com/hc/en-us/sections/204911768-Installation-Upgrade-and-Compatibility[knowledge base
articles], and enterprise support for {pro} customers.
