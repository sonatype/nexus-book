...
https://support.sonatype.com/hc/en-us/articles/217967608[knowledge base article]. This must be done before
<<upgrade-version-two-three,upgrading version 2.x to 3.y>>.
...
WARNING: When running the HTTP download method, we discourage you to synchronize repository manager content to
cloud services or on-premises data centers. This tool is solely designed to allow for data and configuration
