...
version of the latest instance (2.14 or later). See this
link:https://support.sonatype.com/hc/en-us/articles/213464198-How-do-I-upgrade-Nexus-[article] for instructions.
...
As mentioned, {nxrm} 3 represents a shift in design. This shift has involved a new architecture to support more 
advanced features that support today's modern development practices. As such, a number of core changes to data 
stored in version 3.1 (or later) will occur as part of the upgrade process. This includes:
