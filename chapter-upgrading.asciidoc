...
NOTE: Follow these https://support.sonatype.com/hc/en-us/articles/231723267[specific instructions] to upgrade from
3.0.x to 3.1.x or later. Since the release of 3.1.x, the directory structure has changed for this and later versions.
