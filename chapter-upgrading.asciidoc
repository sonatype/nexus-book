...
enabled capability in version 2 is +/service/siesta/migrationagent+. Therefore an example input would be 
+http://localhost:8081/nexus/service/siesta/migrationagent+. The 'Access Token' field will display the security 
key from your version 2 'Migration: Agent' capability details.
