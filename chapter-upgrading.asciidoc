...
how you want to allocate space within the blob stores.

////
Customer ask, why. They have the option to add individual blob store destinations by clicking the wrench icon in he Repository Defaults screen. Explain the paragraph above.
////
