...
+http://localhost:8081/nexus/service/siesta/migrationagent+. The 'Access Token', will display the security key 
from your version 2 'Migration: Agent' capability details.
