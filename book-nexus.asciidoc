...
specifically the usage of Sonatype Nexus OSS, Sonatype Nexus Pro and
Sonatype Nexus Pro+. It details all aspects of set-up and running
Nexus with the features of the latest release version 2.11.2.
